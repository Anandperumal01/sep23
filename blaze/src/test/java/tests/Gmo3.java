...
public class Gmo3 {
	...
	public static void main(String[] args) {
		...
		WebElement btnEnterGMOOnline=driver.findElement(By.xpath("//input[@name='bSubmit']"));
		btnEnterGMOOnline.click();
		
      // driver.findElement(By.name("bSubmit")).click();
		
		WebElement txtQtyTents=driver.findElement(By.xpath("//input[@name='QTY_TENTS']"));
		txtQtyTents.clear();
		txtQtyTents.sendKeys("5");
      //driver.findElement(By.name("QTY_TENTS")).clear();      
      // driver.findElement(By.name("QTY_TENTS")).sendKeys("5");
		
		WebElement txtQtyGlasses=driver.findElement(By.xpath("//input[@name='QTY_GLASSES']"));
		txtQtyGlasses.clear();
     ...
     //  driver.findElement(By.name("QTY_GLASSES")).sendKeys("7");
		...
		WebElement btnPlaceAnOrder=driver.findElement(By.xpath("//input[@name='bSubmit']"));
		btnPlaceAnOrder.click();
      // driver.findElement(By.name("bSubmit")).click();
		
       
	       
		WebElement btnProceedwithOrder=driver.findElement(By.xpath("//input[@name='bSubmit']"));
		btnProceedwithOrder.click();
     //  driver.findElement(By.name("bSubmit")).click();
		
		
	      
		WebElement chkshipSameAsBill=driver.findElement(By.xpath("//input[@name='shipSameAsBill']"));
